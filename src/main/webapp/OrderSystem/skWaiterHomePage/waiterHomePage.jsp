...
<head>
 ...
 <script src="https://cdn.jsdelivr.net/npm/vue/dist/vue.js"></script>
	...
	<script src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
	 ...
	 <link rel="stylesheet" type="text/css" href="css/diancai.css"/>
...
<ul class="layui-nav" lay-bar="disabled">
  ...
  <li class="layui-nav-item">
		...
		<div class="layui-carousel" id="test1">
		  ...
		  <div carousel-item>
		    <div class="lunbo-item">
				<img class="b" src="images/lunbo1.jpg" >
				<img class="m" src="images/lunbo2.jpg" >
				<img class="d" src="images/lunbo3.jpg" >
			</div>
		    <div class="lunbo-item">
				
				<img class="b" src="images/lunbo2.jpg" >
				<img class="m" src="images/lunbo3.jpg" >
				<img  class="d" src="images/lunbo1.jpg" >
				</div>
		    <div class="lunbo-item">
				<img  class="b" src="images/lunbo3.jpg" >
				<img class="m" src="images/lunbo1.jpg" >
				<img class="d" src="images/lunbo2.jpg" >
				</div>
	...
	<div class="dishs_dish">
		...
		<ul class="g2">
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place1.jpg" alt=""></a></li>
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place2.jpg" alt=""></a></li>
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place3jpg.jpg" alt=""></a></li>
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place4.jpeg" alt=""></a></li>
		
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place5.jpg" alt=""></a></li>
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place6.jpeg" alt=""></a></li>
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place7j.jpg" alt=""></a></li>
		<li><a class="example-image-link" href="" data-lightbox="example-set" data-title=" "><img class="example-image" src="images/place8.jpg" alt=""></a></li>
		</ul>
	...
	<div class="best_food_main">
		<div class="best_food_item type_one">
			<img class="best_food_img" src="images/bestone.jpg" >
		...
		<div class="best_food_item type_two">
			...
			<img class="best_food_img" src="images/besttwo.jpg" >
	...
	<script type="text/javascript">
			var cate=new Vue({
				...
				methods:{
					...
					axios.get("http://localhost:8080/TeamWork/getCate.do").then(function(data){			
...
<script src="./assets/live2d.js"></script>
	...
	<style type="text/css">
		...
		.dishs_dish{
			height: 80vh;
			width: 100vw;
			background-image: url(images/placebg.jpg);
